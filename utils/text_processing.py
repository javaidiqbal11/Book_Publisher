...
def extract_key_section(text):
    ...
    pattern = re.compile(
        r"\b("
        r"(INTRODUCTION|CHAPTER 1.|introduction|INTRODUCTION I|Chapter 1|CHAPTER I|Section 1)"
        r")\b(.*?)(?=\b("
        r"OTHER HEADING|CHAPTER 2.|other heading|OTHER SECTION|Chapter 2|CHAPTER II|Section 2"
        r")\b|\Z)",
